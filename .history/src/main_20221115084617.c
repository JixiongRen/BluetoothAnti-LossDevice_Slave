...
void AdjustTheValue()
{
    if (SETBUTT == 1 && ADDBUTT == 1){
        ...
        if (SETBUTT == 1 && ADDBUTT == 1)
        {
            *PositionPointer ++; // TODO 对不同的位设置不同的进制
            if(PositionPointer == &SL){
                while(*PositionPointer == 10){
                    *PositionPointer = 0;
                }
            }
            if(PositionPointer == &SH){
                while(*PositionPointer == 6){
                    *PositionPointer = 0;
                }
            }
            if(PositionPointer == &mL){
                while(*PositionPointer == 10){
                    *PositionPointer = 0;
                }
            }
            if(PositionPointer == &mH){
                while(*PositionPointer == 6){
                    *PositionPointer = 0;
                }
            }
            if(PositionPointer == &HL){
                while(*PositionPointer == 10){
                    *PositionPointer = 0;
                }
            }
            if(PositionPointer == &HH){
                while(*PositionPointer == 2){
                    if(HL > 3){
                        HL = 0;
                        HH = 0;
                    } else {
